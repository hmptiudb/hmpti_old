	...
	<div class="col-12">
		<div class="card">
          <div class="card-header">
            ...
            <a href="<?= base_url() ?>admin/status"" style="float:right"><i class="fas fa-cog fa-lg"></i></a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td id="status-<?php echo $val['id_proker'] ?>"><span class="badge badge-pill badge-<?= $val['id_status']['warna'] ?>"><?php echo $val['id_status']['text'] ?></span></td>
	  		              <td>
	  		              	<div class="btn-group">
...
<div class="col-12 text-right to_top">
	<button  type="button" class="btn btn-lg btn-info rounded-circle" data-toggle="modal" data-target="#modal-add" onclick="statustoadd()"><i class="fas fa-plus"></i></button>
</div>
      ...
      <div class="modal-body">
      	...
      	<div class="container">
            ...
            <div class="form-group">
              ...
              <select id="edit_status" name="id_status" class="form-control">
      ...
      <div class="modal-body">
      	...
      	<div class="container">
            ...
            <div class="form-group">
              ...
              <select id="add_status" name="id_status" class="form-control">
